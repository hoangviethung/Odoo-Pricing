...
var headerVerify = function headerVerify(isInverted) {
  if (isInverted == 'true') {
  ...
  if (wrapper) {
    ...
    items__tab.forEach(function (item) {
      item.addEventListener('click', function (e) {
        var value = item.getAttribute('toggle-for');
        document.querySelector('#form_checkout_hidden').setAttribute('data-customer-segment', value);
      });
    });
  } else {
    console.log('404');
...
var validateFormCheckout = function validateFormCheckout() {
  ...
  var CustomerSegment = document.querySelector('#form_checkout_hidden');

  if (CustomerSegment) {
    var value = CustomerSegment.getAttribute('data-customer-segment');
    console.log(forms);
  } else {
    console.log('404');
  }
...
},{"./libraries/tabs":1,"prettier":3}],3:[function(require,module,exports){
