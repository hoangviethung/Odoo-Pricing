...
var validateFormGlobal = function validateFormGlobal(item) {
...
var validateFormCheckout = function validateFormCheckout() {
  ...
  forms.forEach(function (form) {
    ...
    if (form.getAttribute('tab-id') == CustomerSegment.value) {
      var itemsRequired = form.querySelectorAll('input[required]');
      ...
      form.addEventListener('change', function (e) {
        ...
        if (itemsValid.length == itemsRequired.length) {
          document.querySelector('.hvh-address-management .btn-primary').removeAttribute('disable');
        } else {
          document.querySelector('.hvh-address-management .btn-primary').setAttribute('disable', 'disable');
        }
      });
    }
  });
